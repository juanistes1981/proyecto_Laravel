  ...
  <img id="preguntas"src="./imagenes/preguntasfrecuentes.png" alt="preguntas"style="width: 100%;
    ...
    margin-top: 3em;">
          ...
          <div class="container-faq" >
              <h3 style="height:25%;">¿Cuáles son los medios de pago aceptados?</h3>
          ...
          <div class="container-faq">
                <h3 style="height:20%;">¿Cuánto cuesta el envío?</h3>
        ...
        <div class="container-faq">
              <h3 style="height:20%;">¿En cuánto tiempo recibo mi pedido?</h3>
        ...
        <div class="container-faq">
                <h3 style="height:22%;">Me gustaría enviar un regalo, ¿es posible?</h3>

                <p>Por supuesto! no pierdas la oportuniad de hacer el mejor regalo. Indicala dirección y recibiras la factura en tu email.</p>
        </div>

        <div class="container-faq">
              <h3 style="height:26%;"> No encuentro la respuesta a mi pregunta, ¿qué hago?</h3>
